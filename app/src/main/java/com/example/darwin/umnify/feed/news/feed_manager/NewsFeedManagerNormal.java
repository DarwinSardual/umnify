...
public class NewsFeedManagerNormal<E extends NewsViewHolderNormal> extends NewsFeedManagerGuest<E> {
    ...
    public NewsFeedManagerNormal(Activity activity, SwipeRefreshLayout swipeRefreshLayout, RecyclerView recyclerView,
                                Bundle userData, Class<E> cls, int layoutId){
        super(activity, swipeRefreshLayout, recyclerView, cls, layoutId);
