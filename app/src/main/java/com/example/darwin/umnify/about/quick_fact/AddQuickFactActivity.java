...
import com.example.darwin.umnify.about.trivia.AddTrivia;

public class AddQuickFactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_quick_fact);
    ...
    private class ClickHandler implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            if(view == submitButton){
                ...
                if(data != null){
                    data.putExtra("ADD_QUICK_FACT_CONTENT", contentField.getText().toString());
