...
/**
 * Created by darwin on 9/25/17.
 */

public class UpdateNewsDataActionWrapper implements WebServiceAction{
    ...
    public UpdateNewsDataActionWrapper(HashMap<String, String> textDataOutput, HashMap<String, byte[]> fileDataOutput,
    ...
    public void processRequest() {
        ...
        connection = new WebServiceConnection(AuthenticationAddress.UPDATE_NEWS, activity,
                true, true, true);
