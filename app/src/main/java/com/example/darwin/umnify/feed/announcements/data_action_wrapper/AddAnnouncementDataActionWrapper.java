...
public class AddAnnouncementDataActionWrapper implements WebServiceAction{
    ...
    public AddAnnouncementDataActionWrapper(HashMap<String, String> textDataOutput, HashMap<String, byte[]> fileDataOutput,
    ...
    public void processRequest() {
        ...
        connection = new WebServiceConnection(AuthenticationAddress.ADD_ANNOUNCEMENT, activity,
                true, true, true);
