...
public class FetchEvaluationDataActionWrapper implements WebServiceAction{

    // i need the course and id
    ...
    public FetchEvaluationDataActionWrapper(HashMap<String, String> textDataOutput, Activity activity){
    ...
    public void processRequest() {
        ...
        connection = new WebServiceConnection(AuthenticationAddress.FETCH_EVALUATION, activity, true, true, true);
