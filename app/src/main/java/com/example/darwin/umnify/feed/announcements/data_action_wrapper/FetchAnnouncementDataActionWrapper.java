...
public class FetchAnnouncementDataActionWrapper implements WebServiceAction{
    ...
    public FetchAnnouncementDataActionWrapper(HashMap<String, String> textDataOutput, Activity activity, PostAsyncAction postAsyncAction){
    ...
    public void processRequest() {
        ...
        connection = new WebServiceConnection(AuthenticationAddress.FETCH_ANNOUNCEMENT, activity,
                true, true, true);
